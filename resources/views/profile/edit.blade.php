                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input @if(auth()->user()->role == 0 || auth()->user()->role == 1)disabled
                                           @endif type="text" name="name" id="input-name"
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input @if(auth()->user()->role == 0)disabled @endif type="email" name="email"
                                           id="input-email"
